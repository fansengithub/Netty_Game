...
public class QrCodeCreateUtil {
    ...
    public static void main(String[] args) throws IOException, WriterException {  
       ...
       // createQrCode(new FileOutputStream(new File("d:\\qrcode.jpg")),"http://milk.hotkidclub.com/?phone=123456789777",900,"JPEG");
        readQrCode(new FileInputStream(new File("C:\\upLoadFile\\img\\null.png")));
    }  
