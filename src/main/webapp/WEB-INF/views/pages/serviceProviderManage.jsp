...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            , id: 'opera'
            , cellMinWidth: 100
            , url: '${pageContext.request.contextPath}/huiYuanDetail/selAll2' //数据接口
            , page: true //开启分页
            , cols: [[ //表头
                {field: 'id', title: '服务商ID', width: 200, sort: true, fixed: 'left'}
                , {field: 'name', title: '服务商名', width: 200}
        ...
        table.on('tool(operas)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                window.location.href = "${pageContext.request.contextPath}/huiYuanDetail/serviceProviderDetail.page?id=" + data.id;
            }
        });
    });
