...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,id:'learntable'
            ,cellMinWidth:100
            ,url: '${pageContext.request.contextPath}/get/selAllRechargeDetail' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                ...
                ,{field: 'beforeRecharge', title: '当前余额', width:150, }
                ,{field: 'rechargeMoney', title: '充值金额', width:150, }
                ,{field: 'rechargeObject', title: '到账金额', width:150, }
                ,{field: 'rechargeType', title: '支付方式', width:200, }
                ,{field: 'rechargeTime', title: '充值时间', width:200,templet:"<div>{{layui.util.toDateString(d.rechargeTime, 'yyyy-MM-dd HH:mm:ss')}}</div>" }
                ,{field: 'afterRecharge', title: '剩余金额', width:200, }
...
<script type="text/javascript">
    function goDetail(){
        // var type = $('#type').val();
		alert("www")
        window.location.href="${pageContext.request.contextPath}/get/getTeacherListDetail.page";
    }
</script>
<script>
    //分页
