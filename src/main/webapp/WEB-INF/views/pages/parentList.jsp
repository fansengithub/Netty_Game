...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            , id: 'opera'
            , cellMinWidth: 100
            , url: '${pageContext.request.contextPath}/huiYuanDetail/selAll5' //数据接口
            , page: true //开启分页
            , cols: [[ //表头
                {field: 'id', title: '家长ID', width: 200, sort: true, fixed: 'left'}
                , {field: 'name', title: '家长姓名', width: 200}
                , {field: 'childrenNum', title: '孩子姓名', width: 200}
                , {field: 'telephone', title: '手机号', width: 200}
                , {field: 'childrenNum', title: '孩子数', width: 200}
        ...
        table.on('tool(operas)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                window.location.href = "${pageContext.request.contextPath}/huiYuanDetail/ParentsDetail?id=" + data.id;
            }
        });
    });
