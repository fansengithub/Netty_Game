...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,id:'learntable'
            ,cellMinWidth:100
            ,url: '${pageContext.request.contextPath}/userScore/selAllSongRecord.page' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                ...
                ,{field: 'times', title: '练习时长', width:200}
                ,{field: 'recordTime', title: '记录时间', width:200,templet:"<div>{{layui.util.toDateString(d.recordTime, 'yyyy-MM-dd HH:mm:ss')}}</div>"}
                ,{field: 'firstParam', title: '错误数', width:200}
                ,{field: 'secondParam', title: '正确数', width:200}
                ,{field: 'thirdParam', title: '分数', width:200}
            ]]
            ,request: {
