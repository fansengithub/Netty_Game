        ...
        <form class="layui-form layui-form-pane" id="myFrom">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="holderName" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="bankcardNum" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">银行卡类型</label>
                <div class="layui-input-inline">
                    <input type="text" name="bankcardType" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">开户行地址</label>
                <div class="layui-input-inline">
                    <input type="text" name="opeanBank" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="xxx" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
    ...
    layui.use(['upload','form','layedit'], function() {
        ...
        form.on('submit(addLearnbook)', function(data){
            ...
            if(rid!=null&&rid!=""){
                ...
                console.info("添加")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/BankcardDetail/add.page');
            }
        });
    });
</script>
