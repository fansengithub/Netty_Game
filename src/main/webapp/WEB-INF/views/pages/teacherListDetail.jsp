                        ...
                        <form class="layui-form layui-form-pane" id="myFrom">
                            <table id="dynamic-table"
                                ...
                                <tr class="border">
                                    ...
                                    <td align="center">老师ID：${temp.id}<input type="hidden"
                                                                             value="${temp.id}"
                                                                             name="id" id="fuwuId">
                                    </td>
                                    <td align="center">老师名：${temp.name}</td>
                                ...
                                <tr class="border">
                                    ...
                                    <td align="center">所属琴行：${temp.belongtoPianoShop}</td>

                                    <td align="center">学生总数:0</td>
                                ...
                                <tr class="border">
                                    <td align="center">最后登录时间： <fmt:formatDate value="${temp.lastLoginTime }"
                                                                               type="both"/></td>
                                    <td align="center">就职类型:${temp.workType}</td>
                                    <td align="center">就职单位:${temp.workPlace}</td>
...
<script>
    layui.use(['upload', 'form', 'layer'], function () {
        ...
        form.on('submit(reg)', function (data) {
            ...
            $('form[id=myFrom]').attr('action', '${pageContext.request.contextPath}/huiYuanDetail/TeacherDetailUpdate.page');
        });
        ...
        $("#datade1").click(function (data) {
            ...
            layer.confirm('当前会员已经产生真实数据，确定删除？', function (index) {
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/huiYuanDetail/TeacherDelete.page?id=' + fuwuId,
                    success: function (result) {
                        console.log(result)
                        if (result.code == 0) {
                            // obj.del();
                            layer.msg("删除成功！");
                            window.location.href="${pageContext.request.contextPath}/get/getTeacher.page";
                        } else {
