...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            , id: 'opera'
            , cellMinWidth: 100
            , url: '${pageContext.request.contextPath}/huiYuanDetail/selAll4' //数据接口
            , page: true //开启分页
            , cols: [[ //表头
                {field: 'id', title: '琴行ID', width: 200, sort: true, fixed: 'left'}
                , {field: 'name', title: '琴行名', width: 200}
                , {field: 'belongtoOrginaze', title: '所属机构名', width: 200}
                , {field: 'telephone', title: '手机号', width: 200}
                , {field: 'bossTelephone', title: '法人电话', width: 200}
        ...
        table.on('tool(operas)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                window.location.href = "${pageContext.request.contextPath}/huiYuanDetail/pianoListDetail?id=" + data.id;
            }
        });
    });
