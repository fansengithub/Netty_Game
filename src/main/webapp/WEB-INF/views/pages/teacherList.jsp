...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            , id: 'opera'
            , cellMinWidth: 100
            , url: '${pageContext.request.contextPath}/huiYuanDetail/selAll7' //数据接口
            , page: true //开启分页
            , cols: [[ //表头
                {field: 'id', title: '老师ID', width: 200, sort: true, fixed: 'left'}
                , {field: 'name', title: '姓名', width: 200}
                , {field: 'workType', title: '就职类型', width: 200}
                , {field: 'belongtoPianoShop', title: '所属琴行', width: 200}
        ...
        table.on('tool(operas)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                window.location.href = "${pageContext.request.contextPath}/huiYuanDetail/TeacherDetail?id=" + data.id;
            }
        });
    });
