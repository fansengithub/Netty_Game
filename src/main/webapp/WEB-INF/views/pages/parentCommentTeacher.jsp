						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid"
							...
							<c:forEach var="temp" items="${list}">
								...
								<tr>
									...
									<td>
										<i class="glyphicon glyphicon-trash" title="删除" onclick="goDetail(${temp.id});"></i>
									</td>
								</tr>
							</c:forEach>
    ...
    function goDetail(id){
        ...
        layer.confirm('确定要删除该记录吗？', {
            btn: ['确定','取消'] //按钮
             ...
             window.location.href="${pageContext.request.contextPath}/get/deleteCommentTeacher.page?id="+id;
        }, function(){
            layer.msg('取消成功');
        });
        // var type = $('#type').val();
    ...
    layui.use('laypage', function() {
        ...
        laypage.render({
            ...
            ,jump: function(obj,first){  //跳转  //obj包含了当前分页的所有参数
                console.log(obj)
                if(!first){
                    window.location.href="${pageContext.request.contextPath}/get/parentCommentTeacher.page?curr="+obj.curr+"&limit="+obj.limit;
                }
            }
        });
    });
