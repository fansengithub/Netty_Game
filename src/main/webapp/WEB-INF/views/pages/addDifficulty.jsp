        ...
        <form class="layui-form layui-form-pane" id="myFrom">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="diffityLevel" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['upload','form','layedit'], function() {
        ...
        form.on('submit(addLearnbook)', function(data){
            ...
            if(rid!=null&&rid!=""){
                console.info("修改")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/difficultySet/add.page');
            }else{
                console.info("添加")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/difficultySet/add.page');
            }
