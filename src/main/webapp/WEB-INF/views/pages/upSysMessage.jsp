        ...
        <form class="layui-form layui-form-pane" id="myFrom">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="${sysMessage.content}" name="content" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit="" lay-filter="addLearnbook">立即发送</button>
...
<script>
    layui.use(['upload','form','layedit'], function() {
        ...
        form.on('submit(addLearnbook)', function(data){
            ...
            if(rid!=null&&rid!=""){
                console.info("修改")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/sysMessage/add.page');
            }else{
                console.info("添加")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/sysMessage/add.page');
            }
