...
<div class="main-content-inner">
	<div class="demoTable">
		...
		<select name="type" lay-verify="required" id="adfs">
			<option value="">所有</option>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,id:'learntable'
            ,cellMinWidth:100
            ,url: '${pageContext.request.contextPath}/IncomeDetail/selAll2.page' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                // {field: 'userId', title: '用户ID', width:100, sort: true}
                // ,{field: 'userName', title: '用户名', width:160,},
                {field: 'role', title: '角色', width:100,templet:'#role'}
                ,{field: 'consumpType', title: '收入类型', width: 100,templet:'#consumpType'}
                ,{field: 'incomeCount', title: '总收入金额', width: 100, templet:'#opernNum'}
                ,{field: 'minTime', title: '最后分润时间', width: 200,templet:"<div>{{layui.util.toDateString(d.minTime, 'yyyy-MM-dd HH:mm:ss')}}</div>"}
            ]]
            ,request: {
