...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            , id: 'opera'
            , cellMinWidth: 100
            , url: '${pageContext.request.contextPath}/huiYuanDetail/selAll6' //数据接口
            , page: true //开启分页
            , cols: [[ //表头
                {field: 'id', title: '学生ID', width: 200, sort: true, fixed: 'left'}
                , {field: 'stundentName', title: '姓名', width: 200}
        ...
        table.on('tool(operas)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                window.location.href = "${pageContext.request.contextPath}/huiYuanDetail/StudentsDetail?id=" + data.id;
            }
        });
    });
