        ...
        <form class="layui-form layui-form-pane" id="myFrom">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="${pianoShopScale.id}" id="id" name="id"  readonly autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">琴行规模类型</label>
                <div class="layui-input-inline">
                    <input type="text" value="${pianoShopScale.type}" name="type" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>

            <div class="layui-form-item">
                <label class="layui-form-label">最大老师数量</label>
                <div class="layui-input-inline">
                    <input type="text" value="${pianoShopScale.maxTeacherNum}" name="maxTeacherNum" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['upload','form','layedit'], function() {
        ...
        form.on('submit(addLearnbook)', function(data){
            ...
            if(rid!=null&&rid!=""){
                console.info("修改")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/pianoScope/updatePianScope.page');
            }else{
                console.info("添加")
