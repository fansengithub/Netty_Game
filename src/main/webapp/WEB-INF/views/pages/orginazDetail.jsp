                    ...
                    <div class="row">
                        <form class="layui-form layui-form-pane" id="myFrom">
                            <table id="dynamic-table"
                                    ...
                                    <td align="center">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline" style="width: 100px">
                                                <input value="${temp.organizeName}" style="width:150px;" type="text"
                                                       name="organizeName"
                                ...
                                <tr class="border">
                                    ...
                                    <td align="center">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline" style="width: 100px">
                                                <input value="${temp.boosTelephone}" style="width:150px;" type="text"
                                                       name="boosTelephone" lay-verify="required" autocomplete="off"
                                                       class="layui-input">
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr class="border">
                                    <td align="center">下属琴行总数： ${temp.pianoShopNum}</td>
                                    <td align="center">教材总数： ${temp.learnbookNum}</td>
                                    <td align="center">曲谱总数： ${temp.operabookNum}</td>
                                ...
                                <tr class="border">
                                    ...
                                    <td align="center">会员到期时间： <fmt:formatDate value="${temp.memberTime }"
                                                                               type="both"/></td>
                                    ...
                                    <td align="center">
                                        <div class="layui-form-item" id="fendian">
                                            ...
                                            <div class="layui-input-inline">
                                                <select name="disable" id="state" lay-filter="myselect"
                                                        style="width: 100px">

                                                    <option value="0" <c:if test="${temp.disable==0}">selected</c:if>>正常
                                                    </option>


                                                    <option value="1" <c:if test="${temp.disable==1}">selected</c:if>>封
                                                    </option>
                                ...
                                <tr class="border">
                                    ...
                                    <td align="center" colspan="2">
                                        所在区域:  ${ZnareaShow};
                                        <div class="layui-form-item">
                                            <label class="layui-form-label label1">改变区域:</label>
                                            <div class="layui-input-inline">
                                                <select name="area1"
                                                        id="area1"
                                                        lay-filter="area1">
                                                    ...
                                                    <c:forEach var="stu" items="${znAreaList}" varStatus="status">
                                                        <option value="${stu.areaCede}" <c:if test="${status.last}">selected</c:if>>省:${stu.areaName}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                ...
                                <tr class="border">
                                    <td align="center">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline" style="width: 100px">
                                                <input value="${temp.detailAddress}" style="width:150px;" type="text"
                                                       name="detailAddress" lay-verify="required" autocomplete="off"
                                                       class="layui-input">
                                            </div>
                                        </div>
                                    </td>
...
<script>
    layui.use(['upload', 'form', 'layer'], function () {
        ...
        form.on('submit(reg)', function (data) {
            ...
            $('form[id=myFrom]').attr('action', '${pageContext.request.contextPath}/huiYuanDetail/getOrginazDetailUpdate.page');
        });
        ...
        $("#datade1").click(function (data) {
            ...
            layer.confirm('当前会员已经产生真实数据，确定删除？', function (index) {
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/huiYuanDetail/OrginazDetailDelete.page?id=' + fuwuId,
                    success: function (result) {
                        console.log(result)
                        if (result.code == 0) {
                            // obj.del();
                            layer.msg("删除成功！");
                            window.location.href="${pageContext.request.contextPath}/get/getOrginazList.page";
                        } else {
