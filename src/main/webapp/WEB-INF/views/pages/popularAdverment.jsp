...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,id:'CMStable'
            ,cellMinWidth:100
            ,url: '${pageContext.request.contextPath}/cms/selAll.page?type=2' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'id', title: 'ID', width:80, sort: true}
                ,{field: 'columnName', title: '栏目分类名称', width:100, sort: true ,templet:'#columnName'}
...
<script type="text/javascript">
    function addlearn(){
        ...
        window.location.href="${pageContext.request.contextPath}/get/addAdver.page?type=2";
