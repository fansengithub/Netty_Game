...
<div class="main-content-inner">
    <div class="demoTable">
        ...
        <div class="layui-inline">
            <input class="layui-input" name="keyword" id="serachlearnbook" placeholder="输入用户id" autocomplete="off">
        </div>

        <div class="layui-inline">
            <label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;获得积分最早时间</label>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,id:'learntable'
            ,cellMinWidth:100
            ,url: '${pageContext.request.contextPath}/userScore/selAll.page' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'id', title: '记录序号', width:200, sort: true}
                ,{field: 'playerId', title: '用户id', width:200, sort: true}
                ,{field: 'nickname', title: '用户昵称', width:200}
                ,{field: 'gradenum', title: '拥有积分数量', width:200}
                ,{field: 'info', title: '积分来源', width:150,templet:'#info'}
                ,{field: 'num', title: '新获积分', width: 150, templet:'#opernNum'}
                ,{field: 'time', title: '获得积分时间', width: 180,sort: true,templet:"<div>{{layui.util.toDateString(d.time, 'yyyy-MM-dd HH:mm:ss')}}</div>"}
            ]]
            ,request: {
