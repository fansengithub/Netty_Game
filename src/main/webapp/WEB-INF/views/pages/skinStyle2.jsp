...
<div class="main-content-inner">
	<div class="demoTable">
		...
		<div class="layui-inline">
			<input class="layui-input" name="keyword" id="serachlearnbook" placeholder="输入皮肤风格ID" autocomplete="off">
		</div>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,id:'learntable'
            ,cellMinWidth:100
            ,url: '${pageContext.request.contextPath}/skinStyle/selAll.page' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'id', title: '皮肤风格ID', width:150, sort: true}
                ,{field: 'styleName', title: '皮肤风格名称', width:250,}
                ,{field:'stage', title: '操作',width:150,toolbar:"#learnbookedt"}
            ]]
            ,request: {
        ...
        table.on('tool(learnbooks)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                layer.confirm('确定要删除吗?', function(index){
                    ...
                    $.ajax({
                        url:'${pageContext.request.contextPath}/skinStyle/deleteByKey.page?id='+data.id,
                ...
                window.location.href="${pageContext.request.contextPath}/skinStyle/selectByKey.page?id="+data.id;
            }
        });
    });
