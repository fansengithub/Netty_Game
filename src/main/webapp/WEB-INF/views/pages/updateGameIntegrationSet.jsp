        ...
        <form class="layui-form layui-form-pane" id="myFrom">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="${gameintegrationSet.typeId}" id="id" name="id"  readonly autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">积分内容</label>
                <div class="layui-input-inline">
                    <input type="text" value="${gameintegrationSet.content}" name="content" readonly lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">奖励积分数值</label>
                <div class="layui-input-inline">
                    <input type="text" value="${gameintegrationSet.value}" name="value"   autocomplete="off" class="layui-input">
                </div>
            </div>
...
<script>
    layui.use(['upload','form','layedit'], function() {
        ...
        form.on('submit(addLearnbook)', function(data){
            ...
            if(rid!=null&&rid!=""){
                console.info("修改")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/integration/update2.page');
            }else{
                console.info("添加")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/integration/update2.page');
            }
