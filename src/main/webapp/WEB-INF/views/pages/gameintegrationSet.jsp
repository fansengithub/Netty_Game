...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,id:'learntable'
            ,cellMinWidth:100
            ,url: '${pageContext.request.contextPath}/integration/selAll2.page' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'typeId', title: '类别序号', width:80, sort: true}
        ...
        table.on('tool(learnbooks)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                layer.confirm('确定要删除吗?', function(index){
                    ...
                    $.ajax({
                        url:'${pageContext.request.contextPath}/integration/deleteByKey2.page?id='+data.typeId,
                ...
                window.location.href="${pageContext.request.contextPath}/integration/sel2.page?id="+data.typeId;
            }
        });
    });
