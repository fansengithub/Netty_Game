...
<div class="main-content-inner">
	<div class="demoTable">
		...
		<button class="layui-btn layui-btn-normal"  data-type="add" onclick="addlearn()">新增难度</button>
	</div>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,id:'learntable'
            ,cellMinWidth:100
            ,url: '${pageContext.request.contextPath}/difficultySet/selAll.page' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'id', title: '序号', width:80, sort: true}
                ,{field: 'diffityLevel', title: '难度级别', width:200, sort: true}
        ...
        table.on('tool(learnbooks)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                layer.confirm('确定要删除吗?', function(index){
                    ...
                    $.ajax({
                        url:'${pageContext.request.contextPath}/difficultySet/deleteByKey.page?id='+data.id,
                ...
                window.location.href="${pageContext.request.contextPath}/difficultySet/selectByKey.page?id="+data.id;
            }
        });
    });
