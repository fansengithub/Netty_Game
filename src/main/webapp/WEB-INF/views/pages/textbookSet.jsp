...
<form class="layui-form layui-form-pane" id="myFrom">
    <div class="layui-form-item">
        <label class="layui-form-label" style="width: 260px">曲谱默认免费最大数量</label>
        <div class="layui-input-inline">
            <input type="text" value="${learnbookSet.learnbookNum}" id="id" name="learnbookNum"  autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label" style="width: 260px">老师购买特价教材的最大数量</label>
        <div class="layui-input-inline">
            <input type="text" value="${learnbookSet.teacerBuyBook}" name="teacerBuyBook" lay-verify="required"  autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['upload','form','layedit'], function() {
        ...
        form.on('submit(addLearnbook)', function(data){
            ...
            if(rid!=null&&rid!=""){
                console.info("修改")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/learnboolSet/update.page');
            }else{
                console.info("添加")
                $('form[id=myFrom]').attr('action','${pageContext.request.contextPath}/learnboolSet/update.page');
            }
