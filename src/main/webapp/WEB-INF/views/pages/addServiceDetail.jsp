        ...
        <div class="col-xs-12">
            ...
            <div id="dialog-user-form">
                <form action="${pageContext.request.contextPath}/get/addServiceDetail.page"
                      class="layui-form layui-form-pane" id="" lay-filter="myFrom">
...
<script>
    layui.use(['upload', 'form', 'layer'], function () {
        ...
        form.on('submit(reg)', function (data) {
            ...
            $('form[id=myFrom]').attr('action', '${pageContext.request.contextPath}/get/addServiceDetail.page');
            <%--setTimeout(window.location.href='${pageContext.request.contextPath}/get/addServiceDetail.page',2000);--%>
        });
        ...
        $('#sendyan').click(function () {
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/get/sendSmsCodeByService.page?number=' + telephone,
                success: function (result) {
                    console.log(result)
                    if (result == 1) {
                        layer.msg("发送成功");
