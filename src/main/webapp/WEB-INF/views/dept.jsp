...
<div id="dialog-user-form" style="display: none;">
    <form id="userForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            ...
            <tr>
                <td><label for="userRemark">密码</label></td>
                <td><input type="text" name="password" id="password" class="text ui-widget-content ui-corner-all" /></td>
            </tr>

            <tr>
                <td><label for="xinxiType">身份</label></td>
                <td>
                    <select id="xinxiType" name="xinxiType" data-placeholder="选择状态" style="width: 150px;">
            ...
            <tr>
                <td><label for="xinxiId">信息表中的ID</label></td>
                <td><input type="text" name="xinxiId" id="xinxiId" value="" class="text ui-widget-content ui-corner-all"></td>
            </tr>
...
<script type="application/javascript">
    $(function() {
        ...
        function loadDeptTree() {
            $.ajax({
                url: "${pageContext.request.contextPath}/sys/dept/tree.json",
        ...
        function bindDeptClick() {
            ...
            $(".dept-delete").click(function (e) {
                ...
                if (confirm("确定要删除部门[" + deptName + "]吗?")) {
                    $.ajax({
                        url: "${pageContext.request.contextPath}/sys/dept/delete.json",
                        data: {
                            id: deptId
                        },
                        success: function (result) {
        ...
        function loadUserList(deptId) {
            ...
            var url = "${pageContext.request.contextPath}/sys/user/page.json?deptId=" + deptId;
        ...
        function bindUserClick() {
            $(".user-acl").click(function (e) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/sys/user/acls.json",
                    data: {
                        userId: userId
                    },
                    success: function(result) {
                ...
                $("#dialog-user-form").dialog({
                    ...
                    open: function(event, ui) {
                        ...
                        if (targetUser) {
                            ...
                            //$("#password").val(targetUser.password);
                        }
                    },
                    buttons : {
                        "更新": function(e) {
        ...
        function updateUser(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "${pageContext.request.contextPath}/sys/user/save.json" : "${pageContext.request.contextPath}/sys/user/update.json",
        ...
        function updateDept(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "${pageContext.request.contextPath}/sys/dept/save.json" : "${pageContext.request.contextPath}/sys/dept/update.json",
