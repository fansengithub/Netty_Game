...
<script type="text/javascript">
    $(function() {
        ...
        function loadAclModuleTree() {
            $.ajax({
                url: "${pageContext.request.contextPath}/sys/aclModule/tree.json",
        ...
        function updateAclModule(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "${pageContext.request.contextPath}/sys/aclModule/save.json" : "${pageContext.request.contextPath}/sys/aclModule/update.json",
        ...
        function updateAcl(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "${pageContext.request.contextPath}/sys/acl/save.json" : "${pageContext.request.contextPath}/sys/acl/update.json",
        ...
        function bindAclModuleClick() {
            ...
            $(".aclModule-delete").click(function (e) {
                ...
                if (confirm("确定要删除权限模块[" + aclModuleName + "]吗?")) {
                    $.ajax({
                        url: "${pageContext.request.contextPath}/sys/aclModule/delete.json",
                        data: {
                            id: aclModuleId
                        },
                        success: function (result) {
        ...
        function loadAclList(aclModuleId) {
            ...
            var url = "${pageContext.request.contextPath}/sys/acl/page.json?aclModuleId=" + aclModuleId;
        ...
        function bindAclClick() {
            $(".acl-role").click(function (e) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/sys/acl/acls.json",
                    data: {
                        aclId: aclId
                    },
                    success: function(result) {
