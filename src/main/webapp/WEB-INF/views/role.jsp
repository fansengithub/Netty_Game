...
<script type="text/javascript">
    $(function () {
        ...
        function loadRoleList() {
            $.ajax({
                url: "${pageContext.request.contextPath}/sys/role/list.json",
        ...
        function loadRoleAcl(selectedRoleId) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/sys/role/roleTree.json",
                data : {
        ...
        $(".saveRoleAcl").click(function (e) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/sys/role/changeAcls.json",
                data: {
                    roleId: lastRoleId,
        ...
        function updateRole(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "${pageContext.request.contextPath}/sys/role/save.json" : "${pageContext.request.contextPath}/sys/role/update.json",
        ...
        function loadRoleUser(selectedRoleId) {
            $.ajax({
                url: "${pageContext.request.contextPath}/sys/role/users.json",
                data: {
                    roleId: selectedRoleId
                },
                type: 'POST',
        ...
        $(".saveRoleUser").click(function (e) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/sys/role/changeUsers.json",
                data: {
                    roleId: lastRoleId,
