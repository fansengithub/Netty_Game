...
<body class="no-skin" youdao="bind" style="background: white">
	<form class="layui-form" action="" style="padding: 30px">
		...
		<div class="layui-form-item">
			<label class="layui-form-label" style="width: 200px;">教材风格管理:</label>
...
<script>
    layui.use('form', function(){
        ...
        form.on('submit(formDemo)', function(data){
            ...
            $.ajax({
                url:'${pageContext.request.contextPath}/style/add.page?content='+data.field.content+"&id="+data.field.id,
